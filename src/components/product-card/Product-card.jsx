    ...
    <div className="card shadow-sm bg-body-tertiary rounded">
      ...
      <div className="card__descr-wrapper">
        ...
        <div className="card__links">
          <button className="btn btn-outline-primary" onClick={navigateToProductDetails}>Learn More</button>
          <button className="btn btn-success" onClick={addToCartButtonClick}>Add to Cart</button>
        </div>
      </div>
    </div>
  );
